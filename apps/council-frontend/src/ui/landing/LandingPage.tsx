...
export default function LandingPage(): ReactElement {
  return (
    ...
    <div className="bg-principalRoyalBlue absolute top-0 left-0 right-0 bottom-0 overflow-hidden text-white">
      <Head>
        <title>{t`Welcome | Fiat Council Protocol`}</title>
          ...
          <main className="mt-4 flex flex-col gap-16 xl:mt-0 xl:flex-row xl:gap-24">
            ...
            <div className="flex-1 basis-[60%]">
              <div className="mb-10 mt-4 flex flex-col items-center text-center sm:mb-4 sm:flex-row-reverse sm:text-left lg:items-start">
                <SparkleIcon className="fill-fiatLightGray ml-8 mr-5 lg:flex-1 xl:mr-0" />
                <h1 className="text-fiatLightGray flex-1 text-5xl font-semibold leading-tight sm:text-7xl">{t`Introducing Council`}</h1>
              </div>
