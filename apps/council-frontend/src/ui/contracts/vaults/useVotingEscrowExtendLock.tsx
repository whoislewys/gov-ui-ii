...
export function useVotingEscrowExtendLock(
  address: string | null | undefined,
  signer: Signer | undefined,
): UseMutationResult<
  ContractReceipt | undefined,
  unknown,
  Parameters<VotingEscrow["increaseUnlockTime"]>
> {
  ...
  return useSmartContractTransaction(
    ...
    signer,
    {
      ...
      onTransactionSubmitted: (tx) => {
        ...
        const message = (
          <div>{jt`Extending Lock... ${etherscanLink}`}</div>
        );
      ...
      onTransactionMined: () => {
        ...
        toast.success(t`Lock successfully extended`, {
          id: toastIdRef.current,
        });
      },
    },
