  ...
  return (
    ...
    >
      <div className="flex h-full w-full flex-col justify-center px-8 ">
        <div className="text-fiatWhite font-bold text-opacity-60">{t`Your voting power`}</div>
        <div className="mb-10">
          <div className="text-fiatWhite flex items-center justify-center gap-2 font-bold md:text-3xl">
            <ElementIconCircle
        ...
        <div className="text-fiatWhite font-bold text-opacity-60">{t`will be delegated to`}</div>
        <div className="text-fiatWhite flex items-center justify-center font-bold md:text-3xl">
          <WalletJazzicon
