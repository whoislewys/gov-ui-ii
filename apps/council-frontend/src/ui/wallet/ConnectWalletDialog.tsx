...
export function ConnectWalletDialog({
  ...
  return (
    <SimpleDialog isOpen={isOpen} onClose={onClose}>
      ...
      >
        <H3 className="text-fiatWhite mb-8 text-center">{t`Select Wallet`}</H3>
        <div className="grid grid-cols-3 gap-2">
          <Button
            size={ButtonSize.AUTO}
            variant={ButtonVariant.MINIMAL}
            onClick={handleConnectToMetaMask}
            className="hover:bg-fiatLightGray grid w-full place-items-center shadow-none"
          >
            <div className="grid place-items-center">
              <MetaMaskIcon className="h-16 w-16" />
              <span className="text-fiatWhite mt-2 text-base">MetaMask</span>
            </div>
          </Button>
          <Button
            size={ButtonSize.AUTO}
            ...
            className="hover:bg-fiatLightGray grid w-full place-items-center shadow-none hover:text-white"
          >
            <div className="grid h-full w-full place-items-center">
              <WalletConnectIcon className="h-16 w-16" />
              <span className="text-fiatWhite mt-2 text-base">
                WalletConnect
              </span>
            </div>
          </Button>
          ...
          >
            <div className="grid h-full w-full place-items-center">
              ...
              <span className="text-fiatWhite mt-2 text-base">Coinbase</span>
            </div>
          </Button>
        </div>
        <div className="mt-12">
          <p className="text-fiatOffWhite text-center">
