...
interface VotingEscrowVaultInterface extends ethers.utils.Interface {
  functions: {
...
export class VotingEscrowVault extends BaseContract {
  ...
  interface: VotingEscrowVaultInterface;
