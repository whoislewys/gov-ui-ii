...
interface AbstractComitiumVaultInterface extends ethers.utils.Interface {
  functions: {
...
export class AbstractComitiumVault extends BaseContract {
  ...
  interface: AbstractComitiumVaultInterface;
