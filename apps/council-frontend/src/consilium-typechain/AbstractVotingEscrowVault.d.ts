...
interface AbstractVotingEscrowVaultInterface extends ethers.utils.Interface {
  functions: {
...
export class AbstractVotingEscrowVault extends BaseContract {
  ...
  interface: AbstractVotingEscrowVaultInterface;
