TESTNET_PROPOSALS_JSON=`cat proposals/src/proposals/testnet.proposals.json`
TESTNET_GSC_PROPOSALS_JSON=`cat proposals/src/proposals/testnet-gsc.proposals.json`
GOERLI_PROPOSALS_JSON=`cat proposals/src/proposals/goerli.proposals.json`
GOERLI_GSC_PROPOSALS_JSON=`cat proposals/src/proposals/goerli-gsc.proposals.json`
MAINNET_PROPOSALS_JSON=`cat proposals/src/proposals/mainnet.proposals.json`
MAINNET_GSC_PROPOSALS_JSON=`cat proposals/src/proposals/mainnet-gsc.proposals.json`
...
" > proposals/src/index.ts

# OG
# tsc --project tsconfig.json

tsc --project proposals/tsconfig.json
