...
export const testnetProposals: ProposalsJson = {
  version: "0.0.0",
...
export const testnetGscProposals: ProposalsJson = {
  version: "0.0.0",
  snapshotSpace: "element-finance-goerli.eth",
  proposals: [
    {
...
export const goerliProposals: ProposalsJson = {
  version: "0.0.0",
  snapshotSpace: "fiatdao-goerli.eth",
  proposals: [
    {
      proposalId: "0",
      description:
        "## I'm Baby\n\nLeggings DSA keffiyeh coloring book, tote bag man braid XOXO. Authentic four dollar toast direct trade tousled XOXO lyft wolf chicharrones bodega boys seitan church-key big mood wayfarers green juice crucifix. Hashtag craft beer pop-up neutra man braid sartorial wayfarers offal locavore. Single-origin coffee fixie quinoa umami taiyaki bitters sus cardigan occupy health goth.\n\nEnnui fam retro, you probably haven't heard of them bespoke fixie meggings crucifix. Tonx pickled cold-pressed sriracha, man bun succulents vice. Sartorial pok pok retro big mood, literally succulents bitters unicorn. Coloring book big mood raclette lo-fi, squid sus church-key DIY. Narwhal kickstarter mixtape craft beer YOLO. Cred jean shorts hoodie brunch hashtag +1 paleo praxis pinterest trust fund swag disrupt. Plaid iceland echo park, chartreuse meh tofu you probably haven't heard of them synth kombucha occupy health goth godard mumblecore.",
      title: "Test Proposal 0",
      proposalHash:
        "0xe951c06a15d3e18f088b0cbeba53fc96e99a69c334f8f0c5db8a4411868b89aa",
      unlock: 1662605032,
      lastCall: 0,
      created: 7550801,
      createdTimestamp: 1662605040,
      expiration: 7570290,
      quorum: "0.00000000000760277",
      targets: ["0x36687bdD319a78AB4b4347f3A7459Da235AFc4f4"],
      calldatas: [
        "0x88b49b8364ec53acdd6f74efcba0de586952c40e23aa87d547d57fabb1ee21203b7b09ea",
      ],
      snapshotId:
        "0x55d7eb14721f27d105f1581b3e35bc482d1a95616d9c437e0db899d1ad04e436",
      forumLink: "",
    },
    {
      proposalId: "1",
      ...
      lastCall: 0,
      created: 7550903,
      createdTimestamp: 1662606588,
      expiration: 7570392,
      quorum: "0.000000000007602872",
      targets: [""],
      calldatas: [""],
      snapshotId: "",
      forumLink: "",
    },
    {
      ...
      lastCall: 0,
      created: 7550943,
      createdTimestamp: 1662607224,
      expiration: 7570432,
      quorum: "0.000000000007602912",
      targets: [""],
      calldatas: [""],
      snapshotId: "",
      forumLink: "",
    ...
    {
      proposalId: "3",
      description: "We should do something really cool (but on the blockchain)",
      ...
      lastCall: 0,
      created: 7604349,
      createdTimestamp: 1663349004,
      expiration: 7623838,
      quorum: "0.000000000007656318",
      targets: ["0xc63C514B6c51ea9447250dE62BD5F95856Fb269c"],
      calldatas: [
        "0x88b49b834dce03aeba1d63cf7b6fa0431120dcff456d8264ca09e989e856abbf98eaf755",
      ],
      snapshotId:
        "0xaed4f838fc47ef7bd9929e5056a005ce48b0c912b5e7b544aeb459d03185c053",
      forumLink: "https://google.com",
    },
    {
      proposalId: "4",
      description: "back fiat 50% by dogebonk, 50% by nothing\n\nhire do kwon",
      ...
      lastCall: 0,
      created: 7665441,
      createdTimestamp: 1664232576,
      expiration: 7684930,
      quorum: "0.00000000000771741",
      targets: ["0xc63C514B6c51ea9447250dE62BD5F95856Fb269c"],
      calldatas: [
        "0x88b49b834dce03aeba1d63cf7b6fa0431120dcff456d8264ca09e989e856abbf98eaf755",
      ],
      snapshotId:
        "0xcd173a4141947a7fdd4bc93b70a5f5398052d9c753e87b70926a7a33866b5eff",
      forumLink: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
    },
  ],
};
export const goerliGscProposals: ProposalsJson = {
  version: "0.0.0",
  snapshotSpace: "fiatdao-goerli.eth",
  proposals: [],
};
export const mainnetProposals: ProposalsJson = {
  version: "0.0.0",
...
export const mainnetGscProposals: ProposalsJson = {
  version: "0.0.0",
